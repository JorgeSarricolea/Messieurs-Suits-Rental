...
<body>
    <form id="RU-form" action="./suit_pant_details.php" method="post" enctype="multipart/form-data">
        <?php
        ...
        <div class="form-container">
            <div id="form-data">
                ...
                <div class="input-container">
                    ...
                    <input type="number" name="waist_size" value="<?php echo $waist_size; ?>" placeholder="Ingrese la talla de cintura" required><br>
                </div>

                <div class="input-container">
                    <label for="hip_size">Talla de cadera (cm):</label>
                    <input type="number" name="hip_size" value="<?php echo $hip_size; ?>" placeholder="Ingrese la talla de cadera" required><br>
                </div>
            ...
            <div id="form-image">
                ...
                <input id="send-btn" type="submit" value="<?php echo isset($edit_pant_id) ? 'Guardar cambios' : 'Añadir'; ?>">
            </div>
        </div>
    </form>
